            ...
            <div class="datatable invoice-table">
                <div class="mb-4.5 px-5 flex md:items-center md:flex-row flex-col gap-5">
                    <div class="flex items-center gap-2">
                        <router-link to="/credit_product/add/null" class="btn btn-primary gap-2">
                            <icon-plus />
                            {{$t('add')}}
                        </router-link>
                    </div>
                ...
                >
                    ...
                    <template #actions="data">
                        <div class="flex gap-4 items-center justify-center">
                            <router-link :to="`/credit_product/add/` + data.value.id" class="top-4 ltr:right-4 rtl:left-4 text-gray-400 hover:text-gray-800 dark:hover:text-gray-600 outline-none">
...
<script lang="ts" setup>
    ...
    const rowClick = (product: goodsListInterface) => {
